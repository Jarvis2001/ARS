$(document).ready(function() {
	...
	var fcc = document.getElementById("fccapacity2").value;	
	var fcp = document.getElementById("fcprice2").value;	
	...
	xmlhttp.onreadystatechange = function() {
        ...
        xmlhttp.open("GET","Adminadd.php?flightno="+flightno+"&airplaneid="+airplaneid+"&departure="+departure+"&dtime="+dtime+"&arrival="+arrival+"&atime="+atime+"&ec="+ec+"&ep="+ep+"&bc="+bc+"&bp="+bp+"&fcc="+fcc+"&fcp="+fcp,true);
        xmlhttp.send();      
	...
	var fcc = document.getElementById("fccapacity1").value;	
	var fcp = document.getElementById("fcprice1").value;		
	...
	xmlhttp.onreadystatechange = function() {
        ...
        xmlhttp.open("GET","Adminupdate.php?flightno="+flightno+"&airplaneid="+airplaneid+"&departure="+departure+"&dtime="+dtime+"&arrival="+arrival+"&atime="+atime+"&ec="+ec+"&ep="+ep+"&bc="+bc+"&bp="+bp+"&fcc="+fcc+"&fcp="+fcp,true);
        xmlhttp.send();      
	...
	$("#search").click(function(){
		...
		$.getJSON(url, {flightno: document.getElementById("number").value}, function(data){
			...
			$.each(data.classes, function(i, class_info){
				...
				else if(class_info.name == "Business")
				{
				...
				else
				{
					...
					document.getElementById("fccapacity1").value = class_info.capacity;
					document.getElementById("fcprice1").value = class_info.price;
				}
			});
		}
		});
